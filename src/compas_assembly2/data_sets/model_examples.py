...
def serialize_element():
    ...
    # =========================================================================
    print(e)
    json_dump(e, "element.json", pretty=True)
    json_load("element.json")
    print(e)
...
def serialize_model_node():
    ...
    # serialize the model_node
    # =========================================================================
    json_dump(model_node, "model_node.json", pretty=True)
    json_load("model_node.json")

    # ==========================================================================
    # deserialize the model_node
    # ==========================================================================
    model_node_deserialized = json_load("model_node.json")
...
def serialize_model_tree():
    ...
    # ==========================================================================
    json_dump(model_tree, "model_tree.json", pretty=True)

    # ==========================================================================
    # deserialize the model_tree
    # ==========================================================================
    model_tree_deserialized = json_load("model_tree.json")
...
def serialize_model():
    ...
    # serialize the model_tree
    # ==========================================================================
    json_dump(model, "model.json", pretty=True)

    # ==========================================================================
    # deserialize the model_tree
    # ==========================================================================
    model_deserialized = json_load("model.json")
