...
for i in range(n - 1):
    ...
    elements.append(Element(geometry_simplified=center, geometry=meshes))
...
color_red[0] = 0
Viewer.show_elements(elements, show_grid=False, measurements=measurements, geometry=geometry, color_red=color_red)
