...
for i in range(n - 1):
    ...
    # Create the element
    # --------------------------------------------------------------------------
    element = Element(id=1, geometry_simplified=center, geometry=mesh)
...
color_red[0] = 0
Viewer.show_elements(elements, show_grid=False, measurements=measurements, color_red=color_red)
