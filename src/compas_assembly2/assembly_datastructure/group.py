...
#     def id_of(self, element):
#         """
#         Find the id of the specified element in the ordered multi-key list.

#         Parameters:
#             element (Element): The element to find in the ordered multi-key list.

#         Returns:
#             int: The integer id of the element in the ordered multi-key list, or -1 if not found.

#         Example:
#             group_elements.add(Element(id=(1, 2, 3), l_frame=None, g_frame=None, attr={'t': 'Block', 'm': 30}))
#             group_elements.add(Element(id=(1, 3, 5), l_frame=None, g_frame=None, attr={'t': 'Beam', 'm': 25}))

#             id = group_elements.id_of(Element(id=(1, 3, 5), l_frame=None, g_frame=None,  attr={'t': 'Beam', 'm': 25}))
#             print(id)  # Output: 1
#         """
#         for i, id in enumerate(self.id_list):
#             if element in self._elements[id]:
#                 return i
#         return -1
...
#                     merged_elements.add_element(element)
...
#         """
#         _elements_to_remove = [
#             element for element in self._elements if key in element.attr]
...
#     group_elements = Group()
#     group_elements.add(Element(id=(1, 2, 3), l_frame=Frame.worldXY(),
#                                g_frame=Frame.worldXY(), attr={'t': 'Block', 'm': 30}))
#     group_elements.add(Element(id=(3, 0, 3), l_frame=Frame.worldXY(),
#                                g_frame=Frame.worldXY(), attr={'t': 'Beam', 'm': 25}))
#     group_elements.add(Element(id=(0, 2, 4), l_frame=Frame.worldXY(),
#                                g_frame=Frame.worldXY(), attr={'t': 'Block', 'm': 25}))
#     group_elements.add(Element(id=(1, 0, 3), l_frame=Frame.worldXY(),
#                                g_frame=Frame.worldXY(), attr={'t': 'Plate', 'm': 40}))
#     group_elements.add(Element(id=(2, 2), l_frame=Frame.worldXY(),
#                                g_frame=Frame.worldXY(), attr={'t': 'Block', 'm': 30}))
