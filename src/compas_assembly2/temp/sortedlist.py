...
# except ImportError:
#     from collections import Sequence, MutableSequence  # type: ignore

# from functools import wraps
# from sys import hexversion

# if hexversion < 0x03000000:
#     from itertools import imap as map  # type: ignore # pylint: disable=redefined-builtin
#     from itertools import izip as zip  # type: ignore # pylint: disable=redefined-builtin

#     try:
#         from thread import get_ident  # type: ignore
#     except ImportError:
#         from dummy_thread import get_ident  # type: ignore
# else:
...
#     except ImportError:
#         from _dummy_thread import get_ident  # type: ignore
...
#     def __init__(self, iterable=None, key=None):  # type: ignore
...
#         _load = self._load
#         _lists.extend(values[pos : (pos + _load)] for pos in range(0, len(values), _load))  # noqa
...
#                 middle = _lists[(start_pos + 1) : stop_pos]  # noqa: E203
...
#     def __make_cmp(seq_op, symbol, doc):  # type: ignore
...
#     __lt__ = __make_cmp(lt, "<", "less than")  # type: ignore
