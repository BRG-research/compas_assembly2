...
from compas_assembly2.sortedset import SortedSet
...
try:
    ...
    from collections import ItemsView, KeysView, Mapping, ValuesView, Sequence  # type: ignore
...
class SortedDict(dict):
    ...
    * :func:`SortedKeyList.irange_key`
    ...
    if sys.hexversion < 0x03000000:
        ...
        def __make_raise_attributeerror(original, alternate):  # type: ignore
