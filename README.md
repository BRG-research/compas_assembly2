...
* BOOK-KEEPING OBJECTS IN A SMARTER COLLECTION In many packages elements, joints are stored in a list. The list itself can be changed to something more such as an OrderedList with grouping functionality and selection methods for retrieving objects based on element or joint attributes.
